...
class VetrolAuthProvider extends EloquentUserProvider
{
    public function retrieveByCredentials(array $credentials)
    {
        ...
        $authenticateByAnyEmail = config('vetrol-auth.authenticate_by_any_email', false);
